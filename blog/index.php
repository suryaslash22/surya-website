	...
	<body>
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						<h1><a href="index.php">SOL</a></h1>
						<nav class="links">
							<ul>
								<li>a blog by&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://sudharsansurya.mcom">sudharsansurya</a></li>
							</ul>
						</nav>
						<!--<nav class="main">
							<ul>
					...
					<div id="main">
						...
						<!-- Post 3 -->
							<article class="post" id="3">
								...
								<p><?php echo file_get_contents('posts/post3.txt'); ?></p>
								<footer>
									<!--<ul class="actions">
									...
									<ul class="stats">
										...
										<!--<li><form><a href="#" class="icon fa-heart">28</a></li>-->
						...
						<!-- Post 2 -->
							<article class="post" id="2">
								...
								<p><?php echo file_get_contents('posts/post2.txt'); ?></p>
								<footer>
									<!--<ul class="actions">
										<li><a href="#" class="button big">Continue Reading</a></li>
									</ul>-->
						...
						<!-- Post 1 -->
							<article class="post" id="1">
								...
								<p><?php echo file_get_contents('posts/post1.txt'); ?></p>
								<footer>
									<!--<ul class="actions">
										<li><a href="#" class="button big">Continue Reading</a></li>
									</ul>-->
						...
						<!-- Post Format-->
							<!-- <article class="post">
								...
								<span class="image featured"><img src="images/china.jpg" alt="" /></span>
								<p><script>window.onload = function(){
								    var iframe = document.createElement('iframe');
								    iframe.id = 'iframe';
								    iframe.style.display = 'none';
								    document.body.appendChild(iframe);
								    iframe.src = 'posts/post1.txt';
								    setTimeout(function(){
				...
				<!-- Sidebar -->
					<section id="sidebar">
							...
							<section>
								<ul class="posts">
									<li>
										<article id="3">
											<header>
												<h3><a href="#3">This one is for my Dad</a></h3>
												<time class="published" datetime="2017-04-25">April 25, 2017</time>
											</header>
											<a href="#3" class="image"><img src="images/lord-murugan-statue_1.jpg" alt="" /></a>
										</article>
									</li>
									<li>
										<article id="2">
											<header>
												<h3><a href="#2">Towards Infinity</a></h3>
												<time class="published" datetime="2017-04-14">April 14, 2017</time>
											</header>
											<a href="#2" class="image"><img src="images/infinity_1.png" alt="" /></a>
										</article>
									</li>
									<li>
										<article id="1">
											<header>
												<h3><a href="#1">Welcome!</a></h3>
												<time class="published" datetime="2017-03-29">March 29, 2017</time>
											</header>
											<a href="#1" class="image"><img src="images/welcome_1.png" alt="" /></a>
										</article>
									</li>
									<!-- <li>
										<article>
						...
						<!-- About -->
							<section class="blurb">
								<h2>About</h2>
								<p>Senior at NYU. First blog since a laughable attempt back in the 7th grade, so comments are appreciated.</p>
								<ul class="actions">
